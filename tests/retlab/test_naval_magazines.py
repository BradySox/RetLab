"""§81 cross-turn naval magazines — the campaign side.
...
anti-ship weapon patterns never overlap §63's land-attack families (so a shot is
...
from game.retlab.naval_magazines import (
...
def test_the_antiship_patterns_never_match_a_land_attack_cruise_missile() -> None:
    """The §63/§81 disjointness guarantee: neither magazine may charge the other's
    shot. The land-attack families are the ones §63 meters."""
    land_attack = [
        "BGM_109B",
        "BGM_109",
