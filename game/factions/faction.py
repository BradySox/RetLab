...
class Faction:
    ...
    def apply_mod_settings(self, mod_settings: Optional[ModSettings] = None) -> None:
        ...
        if not mod_settings.high_digit_sams:
            ...
            self.remove_preset("SAMP/T")
            self.remove_preset("SAMP/T NG")
            ...
            # NOTE: remove_vehicle matches the DCS unit type *id*, not the
            # display name (the pre-Ultimate strips used names and silently
            # never removed anything).
            self.remove_vehicle("SA-14 Strela-3 manpad")
            self.remove_vehicle("SA-7 Strela-2 manpad")
            self.remove_vehicle("SA-7b Strela-2M manpad")
            self.remove_vehicle("SA-24 Igla-S manpad")
            self.remove_vehicle("polyana-d4m1 cp")
            self.remove_vehicle("Pantsir_SM")
            self.remove_vehicle("EWR P-37 BAR LOCK")
            self.remove_vehicle("EWR 55G6U NEBO-U")
            self.remove_vehicle("EWR 1L119 Nebo-SVU")
            self.remove_vehicle("EWR Generic radar tower")
            self.remove_vehicle("ERO_ZU23_Toyota")
            self.remove_vehicle("ERO_ZU23_Toyota_armored")
            self.remove_vehicle("ERO_ZU23_Insurgent")
            self.remove_vehicle("ERO_Toyota_Camo")
            self.remove_vehicle("ERO_SA2_SNR75")
            self.remove_vehicle("ERO_SA2_Trailer")
            self.remove_vehicle("ERO_5S99_Trailer")
        ...
        if not mod_settings.usamilitaryassetspack:
            ...
            self.remove_vehicle("CH_MIM104_M903_PAC2")
            self.remove_vehicle("CH_MIM104_M903_PAC3")
            self.remove_vehicle("CH_MIM104_ECS")
            self.remove_vehicle("CH_MIM104_ANMPQ65")
            self.remove_vehicle("CH_MIM104_ANMPQ65A")
            self.remove_vehicle("CH_MIM104_LTAMDS")
            self.remove_vehicle("CH_MIM104_EPP")
            self.remove_vehicle("CH_MIM104_M903_PAC2_HEMTT")
            self.remove_vehicle("CH_MIM104_M903_PAC3_HEMTT")
            self.remove_vehicle("CH_MIM104_ANMPQ65_HEMTT")
            self.remove_vehicle("CH_MIM104_ANMPQ65A_HEMTT")
            self.remove_vehicle("CH_MIM104_LTAMDS_HEMTT")
            self.remove_vehicle("CH_MIM104_M901_PAC2_KAT1")
            self.remove_vehicle("CH_MIM104_ANMPQ53_KAT1")
            self.remove_vehicle("CH_MIM104_ECS_KAT1")
            self.remove_vehicle("CH_MIM104_EPP_KAT1")
            ...
            self.remove_vehicle("CH_AbramsX")
        ...
        if not mod_settings.ukmilitaryassetspack:
            ...
            self.remove_vehicle("CH_Challenger2")
            self.remove_vehicle("CH_Challenger3")
